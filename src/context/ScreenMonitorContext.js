...
───────────────────────────────────────────── */
const IMAGEKIT_URL_ENDPOINT  = process.env.REACT_APP_IMAGEKIT_URL_ENDPOINT || 'https://ik.imagekit.io/Nihal1521';
const IMAGEKIT_PUBLIC_KEY    = process.env.REACT_APP_IMAGEKIT_PUBLIC_KEY   || 'public_3HjwZHol9NlStvSZQI+0ycrfm5U=';
const IMAGEKIT_AUTH_ENDPOINT = process.env.REACT_APP_IMAGEKIT_AUTH_ENDPOINT|| '/api/imagekit-auth'; // your backend route
